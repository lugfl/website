...
BLOG_AUTHOR = "Linux User Group Flensburg e.V."  # (translatable)
BLOG_TITLE = "Linux User Group Flensburg e.V."  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = os.getenv("LUGFL_SITE_URL","http://www2.lugfl.de/")
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.lugfl.de/"
BLOG_EMAIL = "info@lugfl.de"
BLOG_DESCRIPTION = "Die Linux User Group Flensburg setzt sich für OpenSource und besonders für das Betriebssystem Linux ein. Jeweils am 4. Freitag im Monat findet unser Linux Einsteiger Abend statt, zu dem jeder gerne eingeladen ist."  # (translatable)
...
MOMENTJS_DATE_FORMAT = 'HH:mm DD-MM-YYYY'
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>          Designed by <a href="https://colorlib.com" target="_blank">Colorlib</a>       {license}'
